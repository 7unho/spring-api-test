package com.april2nd.jwtlogintest.service;

import com.april2nd.jwtlogintest.dto.TokenIndexRes;
...
import com.april2nd.jwtlogintest.repo.AuthRepository;
...
public class UserService {
    ...
    public TokenRes register(UserReq userRequest){
    ...
    @Transactional
    public TokenRes doLogin(UserReq userRequest) throws Exception {
    ...
    public TokenRes issueAccessToken(HttpServletRequest request){
    ...
    public TokenIndexRes registerIndex(UserReq userRequest){
        User user = User.builder()
                .userId(userRequest.getUserId())
                .userPw(passwordEncoder.encode(userRequest.getUserPw()))
                .build();
    ...
    public TokenIndexRes issueAccessIndexToken(HttpServletRequest request){
        String accessToken = jwtTokenProvider.resolveAccessToken(request);
